...
var G__33087 = format;
var G__33087__$1 = (((G__33087 instanceof cljs.core.Keyword))?G__33087.fqn:null);
switch (G__33087__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__33093 = cljs.core.second(format);
var G__33094 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__33093,G__33094) : ajax.easy.keyword_response_format_element.call(null,G__33093,G__33094));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__33096 = format;
var G__33096__$1 = (((G__33096 instanceof cljs.core.Keyword))?G__33096.fqn:null);
switch (G__33096__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__33097_SHARP_){
return ajax.easy.keyword_response_format_element(p1__33097_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__33107){
var map__33108 = p__33107;
var map__33108__$1 = (((((!((map__33108 == null))))?(((((map__33108.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33108.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33108):map__33108);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33108__$1,new cljs.core.Keyword(null,"handler","handler",-195596612));
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33108__$1,new cljs.core.Keyword(null,"error-handler","error-handler",-484945776));
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33108__$1,new cljs.core.Keyword(null,"finally","finally",1589088705));
...
return (function ajax$easy$transform_handler_$_easy_handler(p__33110){
var vec__33111 = p__33110;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33111,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__33111,(1),null);
var fexpr__33114_33123 = (cljs.core.truth_(ok)?h:e);
(fexpr__33114_33123.cljs$core$IFn$_invoke$arity$1 ? fexpr__33114_33123.cljs$core$IFn$_invoke$arity$1(result) : fexpr__33114_33123.call(null,result));
...
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__33115){
...
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33116__$1,new cljs.core.Keyword(null,"method","method",55703592));
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33116__$1,new cljs.core.Keyword(null,"format","format",-1306924766));
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33116__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33116__$1,new cljs.core.Keyword(null,"params","params",710516235));
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33116__$1,new cljs.core.Keyword(null,"body","body",-2049205669));
