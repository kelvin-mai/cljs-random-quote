...
(ajax.protocols.Response.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k32490,else__4442__auto__){
var self__ = this;
var this__4441__auto____$1 = this;
var G__32494 = k32490;
var G__32494__$1 = (((G__32494 instanceof cljs.core.Keyword))?G__32494.fqn:null);
switch (G__32494__$1) {
case "status":
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k32490,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__32495){
var vec__32496 = p__32495;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32496,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__32496,(1),null);
...
(ajax.protocols.Response.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__32489){
var self__ = this;
var G__32489__$1 = this;
return (new cljs.core.RecordIter((0),G__32489__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"status","status",-1997798413),new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__32499 = (function (coll__4436__auto__){
return (-473222333 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__32499(this__4435__auto____$1);
})();
...
(ajax.protocols.Response.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this32491,other32492){
var self__ = this;
var this32491__$1 = this;
return (((!((other32492 == null)))) && ((this32491__$1.constructor === other32492.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32491__$1.status,other32492.status)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32491__$1.body,other32492.body)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32491__$1.status_text,other32492.status_text)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32491__$1.headers,other32492.headers)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32491__$1.was_aborted,other32492.was_aborted)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this32491__$1.__extmap,other32492.__extmap)));
}));
...
(ajax.protocols.Response.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__32489){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__32500 = cljs.core.keyword_identical_QMARK_;
var expr__32501 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__32503 = new cljs.core.Keyword(null,"status","status",-1997798413);
var G__32504 = expr__32501;
return (pred__32500.cljs$core$IFn$_invoke$arity$2 ? pred__32500.cljs$core$IFn$_invoke$arity$2(G__32503,G__32504) : pred__32500.call(null,G__32503,G__32504));
})())){
return (new ajax.protocols.Response(G__32489,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__32505 = new cljs.core.Keyword(null,"body","body",-2049205669);
var G__32506 = expr__32501;
return (pred__32500.cljs$core$IFn$_invoke$arity$2 ? pred__32500.cljs$core$IFn$_invoke$arity$2(G__32505,G__32506) : pred__32500.call(null,G__32505,G__32506));
})())){
return (new ajax.protocols.Response(self__.status,G__32489,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__32507 = new cljs.core.Keyword(null,"status-text","status-text",-1834235478);
var G__32508 = expr__32501;
return (pred__32500.cljs$core$IFn$_invoke$arity$2 ? pred__32500.cljs$core$IFn$_invoke$arity$2(G__32507,G__32508) : pred__32500.call(null,G__32507,G__32508));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,G__32489,self__.headers,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__32509 = new cljs.core.Keyword(null,"headers","headers",-835030129);
var G__32510 = expr__32501;
return (pred__32500.cljs$core$IFn$_invoke$arity$2 ? pred__32500.cljs$core$IFn$_invoke$arity$2(G__32509,G__32510) : pred__32500.call(null,G__32509,G__32510));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,G__32489,self__.was_aborted,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__32511 = new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828);
var G__32512 = expr__32501;
return (pred__32500.cljs$core$IFn$_invoke$arity$2 ? pred__32500.cljs$core$IFn$_invoke$arity$2(G__32511,G__32512) : pred__32500.call(null,G__32511,G__32512));
})())){
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,G__32489,self__.__meta,self__.__extmap,null));
} else {
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__32489),null));
}
}
}
}
...
(ajax.protocols.Response.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__32489){
var self__ = this;
var this__4438__auto____$1 = this;
return (new ajax.protocols.Response(self__.status,self__.body,self__.status_text,self__.headers,self__.was_aborted,G__32489,self__.__extmap,self__.__hash));
}));
 ...
 */
ajax.protocols.map__GT_Response = (function ajax$protocols$map__GT_Response(G__32493){
var extmap__4478__auto__ = (function (){var G__32513 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__32493,new cljs.core.Keyword(null,"status","status",-1997798413),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"body","body",-2049205669),new cljs.core.Keyword(null,"status-text","status-text",-1834235478),new cljs.core.Keyword(null,"headers","headers",-835030129),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828)], 0));
if(cljs.core.record_QMARK_(G__32493)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__32513);
} else {
return G__32513;
}
})();
return (new ajax.protocols.Response(new cljs.core.Keyword(null,"status","status",-1997798413).cljs$core$IFn$_invoke$arity$1(G__32493),new cljs.core.Keyword(null,"body","body",-2049205669).cljs$core$IFn$_invoke$arity$1(G__32493),new cljs.core.Keyword(null,"status-text","status-text",-1834235478).cljs$core$IFn$_invoke$arity$1(G__32493),new cljs.core.Keyword(null,"headers","headers",-835030129).cljs$core$IFn$_invoke$arity$1(G__32493),new cljs.core.Keyword(null,"was-aborted","was-aborted",-2120084828).cljs$core$IFn$_invoke$arity$1(G__32493),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
