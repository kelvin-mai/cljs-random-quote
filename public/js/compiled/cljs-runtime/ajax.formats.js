...
ajax.formats.get_default_format = (function ajax$formats$get_default_format(response,p__33045){
...
var request = map__33046__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33046__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
...
var fexpr__33051 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__33051.cljs$core$IFn$_invoke$arity$1 ? fexpr__33051.cljs$core$IFn$_invoke$arity$1(response) : fexpr__33051.call(null,response));
}));

(ajax.formats.detect_response_format_read.cljs$core$IFn$_invoke$arity$1 = (function (request){
return (function (response){
var format = ajax.formats.get_default_format(response,request);
var fexpr__33052 = new cljs.core.Keyword(null,"read","read",1140058661).cljs$core$IFn$_invoke$arity$1(format);
return (fexpr__33052.cljs$core$IFn$_invoke$arity$1 ? fexpr__33052.cljs$core$IFn$_invoke$arity$1(response) : fexpr__33052.call(null,response));
});
}));

(ajax.formats.detect_response_format_read.cljs$lang$maxFixedArity = 2);

ajax.formats.accept_header = (function ajax$formats$accept_header(p__33053){
var map__33054 = p__33053;
var map__33054__$1 = (((((!((map__33054 == null))))?(((((map__33054.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__33054.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__33054):map__33054);
var request = map__33054__$1;
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__33054__$1,new cljs.core.Keyword(null,"response-format","response-format",1664465322));
