...
if((i < len)){
var k = (ks[i]);
var G__41688 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__41689 = (i + (1));
m = G__41688;
i = G__41689;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__41563 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__41563);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41569 = c;
var G__41569__$1 = (((G__41569 == null))?null:G__41569.prototype);
if((G__41569__$1 == null)){
return null;
} else {
return (G__41569__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__41577 = c;
var G__41577__$1 = (((G__41577 == null))?null:G__41577.prototype);
if((G__41577__$1 == null)){
return null;
} else {
return (G__41577__$1["render"]);
}
})() == null)))));
});
...
var G__41590 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__41590) : reagent.impl.component.as_element.call(null,G__41590));
};
...
var _STAR_current_component_STAR__orig_val__41625 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__41626 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__41626);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__41625);
}});
...
var c = this;
var G__41639_41716 = (c["cljsRatom"]);
if((G__41639_41716 == null)){
} else {
reagent.ratom.dispose_BANG_(G__41639_41716);
}
...
var renders_41723 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_41724 = cljs.core.first(cljs.core.vals(renders_41723));
if((cljs.core.count(renders_41723) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_41723))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_41724)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_41724], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__41661 = name;
switch (G__41661) {
case "":
...
var G__41674 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__41674);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__41677 = fiber;
var G__41677__$1 = (((G__41677 == null))?null:(G__41677["type"]));
if((G__41677__$1 == null)){
return null;
} else {
return (G__41677__$1["displayName"]);
}
})();
var parent = (function (){var G__41678 = fiber;
if((G__41678 == null)){
return null;
} else {
return (G__41678["return"]);
}
})();
var path = (function (){var G__41679 = parent;
var G__41679__$1 = (((G__41679 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__41679) : reagent.impl.component.fiber_component_path.call(null,G__41679)));
if((G__41679__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41679__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var G__41680 = c;
if((G__41680 == null)){
return null;
} else {
return (G__41680["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__41681 = (function (){var or__4185__auto__ = (function (){var G__41683 = c;
if((G__41683 == null)){
return null;
} else {
return (G__41683["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return (G__41681["_currentElement"]);
}
})();
var name = (function (){var G__41684 = elem;
var G__41684__$1 = (((G__41684 == null))?null:(G__41684["type"]));
if((G__41684__$1 == null)){
return null;
} else {
return (G__41684__$1["displayName"]);
}
})();
var path = (function (){var G__41685 = elem;
var G__41685__$1 = (((G__41685 == null))?null:(G__41685["_owner"]));
var G__41685__$2 = (((G__41685__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__41685__$1) : reagent.impl.component.component_path.call(null,G__41685__$1)));
if((G__41685__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__41685__$2)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__41686 = c;
var G__41686__$1 = (((G__41686 == null))?null:G__41686.constructor);
if((G__41686__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__41686__$1);
}
}
})();
