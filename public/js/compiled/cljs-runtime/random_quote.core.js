...
random_quote.core.app_state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"text","text",-1790561697),"Hello world!",new cljs.core.Keyword(null,"author","author",2111686192),"Kelvin Mai"], null));
}
...
}),new cljs.core.Keyword(null,"error-handler","error-handler",-484945776),(function (p__26801){
...
var status = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26802__$1,new cljs.core.Keyword(null,"status","status",-1997798413));
var status_text = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__26802__$1,new cljs.core.Keyword(null,"status-text","status-text",-1834235478));
...
var G__26804 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [random_quote.core.my_quote,random_quote.core.app_state], null);
var G__26805 = document.getElementById("app");
return (reagent.core.render_component.cljs$core$IFn$_invoke$arity$2 ? reagent.core.render_component.cljs$core$IFn$_invoke$arity$2(G__26804,G__26805) : reagent.core.render_component.call(null,G__26804,G__26805));
});
