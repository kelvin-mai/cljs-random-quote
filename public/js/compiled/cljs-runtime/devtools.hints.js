...
var temp__5733__auto__ = cljs.core.deref(devtools.hints.processed_errors);
...
var G__30595 = cljs.core.PersistentArrayMap.EMPTY;
var G__30596 = native_stack_trace;
var G__30597 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__30598 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__30595,G__30596,G__30597,G__30598) : cljs.stacktrace.parse_stacktrace.call(null,G__30595,G__30596,G__30597,G__30598));
});
...
var map__30604 = top_item;
var map__30604__$1 = (((((!((map__30604 == null))))?(((((map__30604.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__30604.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__30604):map__30604);
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30604__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30604__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__30604__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e30600){var _e = e30600;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___30673 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___30673)){
var seen_errors_30674 = temp__5733__auto___30673;
if(cljs.core.truth_(seen_errors_30674.has(self))){
} else {
seen_errors_30674.add(self);

var temp__5735__auto___30675 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___30675)){
var sense_30676 = temp__5735__auto___30675;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_30676)].join(''));
} else {
}
}
} else {
