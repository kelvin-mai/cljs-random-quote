...
var G__41704 = o;
(G__41704[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__41758__delegate = function (args){
...
while (G__41759__i < G__41759__a.length) {G__41759__a[G__41759__i] = arguments[G__41759__i + 0]; ++G__41759__i;}
  args = new cljs.core.IndexedSeq(G__41759__a,0,null);
} 
return G__41758__delegate.call(this,args);};
G__41758.cljs$lang$maxFixedArity = 0;
G__41758.cljs$lang$applyTo = (function (arglist__41760){
var args = cljs.core.seq(arglist__41760);
return G__41758__delegate(args);
});
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__41706){
...
var props = map__41707__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41707__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__41709){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41710__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
(reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__41720){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41721__$1,new cljs.core.Keyword(null,"synthetic-on-update","synthetic-on-update",1615571932));
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41721__$1,new cljs.core.Keyword(null,"synthetic-on-change","synthetic-on-change",-2073813537));
...
var G__41726 = jsprops;
(G__41726["defaultValue"] = value);

(G__41726["onChange"] = (function (p1__41717_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__41717_SHARP_);
}));
...
var vec__41728 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41728,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41728,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41728,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___41821 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___41821 == null)){
} else {
var key_41822 = temp__5739__auto___41821;
(jsprops["key"] = key_41822);
}
...
(reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__41737){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41738__$1,new cljs.core.Keyword(null,"synthetic-input","synthetic-input",-135147697));
...
var wrapped = (function (){var G__41740 = reagent.impl.template.__GT_NativeWrapper();
(G__41740["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__41741 = wrapped;
(G__41741["syntheticInput"] = true);

return G__41741;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__41742 = wrapped__$1;
(G__41742["syntheticOnChange"] = on_change);

return G__41742;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__41743 = wrapped__$2;
(G__41743["syntheticOnUpdate"] = on_update);
...
var len__4789__auto___41837 = arguments.length;
var i__4790__auto___41838 = (0);
while(true){
if((i__4790__auto___41838 < len__4789__auto___41837)){
args__4795__auto__.push((arguments[i__4790__auto___41838]));

var G__41839 = (i__4790__auto___41838 + (1));
i__4790__auto___41838 = G__41839;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq41747){
...
break;
default:
var G__41845 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__41845;
continue;
...
var n__4666__auto___41846 = a.length;
var i_41847 = (0);
while(true){
if((i_41847 < n__4666__auto___41846)){
(a[i_41847] = reagent.impl.template.as_element((a[i_41847])));

var G__41848 = (i_41847 + (1));
i_41847 = G__41848;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___41850 = a.length;
var i_41851 = (0);
while(true){
if((i_41851 < n__4666__auto___41850)){
var val_41852 = (a[i_41851]);
if(((cljs.core.vector_QMARK_(val_41852)) && ((reagent.impl.template.key_from_vec(val_41852) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_41851] = reagent.impl.template.as_element(val_41852));

var G__41853 = (i_41851 + (1));
i_41851 = G__41853;
continue;
} else {
}
...
var ctx = ({});
var vec__41751 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41751,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41751,(1),null);
...
var G__41754 = (cljs.core.count(argv) - first_child);
switch (G__41754) {
case (0):
...
case (1):
var G__41755 = comp;
var G__41756 = jsprops;
var G__41757 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__41755,G__41756,G__41757);
